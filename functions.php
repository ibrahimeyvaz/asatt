...
include_once('functions/function-scripts.php');

// Userroles

include_once('functions/function-userroles.php');


// Custom post types
include_once('functions/function-post-types.php');
...
// Sidebars
include_once('functions/function-sidebars.php');


// Image sizes
include_once('functions/function-image-sizes.php');


// Featured image
include_once('functions/function-featured-image.php');


// ACF functions
include_once('functions/function-acf.php');


// Disable unneccesary WP functionality
include_once('functions/function-clean-up.php');


// Add custom css to WP back-end
include_once('functions/function-admin-styles.php');
